...
class NewMaterialReceivedActivity : AppCompatActivity(), MaterialSelectionLibraryDialogFragment.OnMaterialListReceived{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_new_material_received)
        ...
        makeRequestButton.setOnClickListener {
            ...
            if(requestedMaterialHashMap.size == 0){
                ...
                if (projectId != null) {
                    firebaseOperationsForProjectInternalMaterialTab.saveMaterialReceived(projectId, requestedMaterialHashMap)
                    finish()
                }else{
