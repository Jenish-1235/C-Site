    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (projectId != null && transactionId != null && transactionType != null){
            if(transactionType == "Material Purchase"){
                firebaseOperationsForProjectInternalTransactionsTab.fetchMaterialPurchaseTransaction(projectId, transactionId, object : FirebaseOperationsForProjectInternalTransactionsTab.OnMaterialPurchaseTransactionFetched{
                    override fun onTransactionFetched(materialPurchase: TransactionMaterialPurchase) {
                        ...
                        b.txnPartyNameView.text = "Party Name: " + materialPurchase.transactionParty
                        b.txnAdditionalChargesView.text = "Additional Charges: \u20b9" + materialPurchase.mpAdditionalCharge
                        b.txnDiscountView.text = "Discount: \u20b9" + materialPurchase.mpDiscount
                        b.txnCategoryView.text = "Category: " + materialPurchase.mpCategory
                        b.txnAmountView.text = "Amount: \u20b9" + materialPurchase.transactionAmount
                        b.txnDescriptionView.text = "Description: " + materialPurchase.transactionDescription
                        val materialList = ArrayList<String>()
                        for(material in materialPurchase.mpItems.values){
                            val materialData = material.materialName + "   " + material.materialQuantity + material.materialUnit + " * \u20b9" + material.materialUnitRate + " = \u20b9" + (material.materialQuantity.toDouble()*material.materialUnitRate.toDouble())
                            materialList.add(materialData)
                        }
                        val adapter = ArrayAdapter(this@MaterialPurchaseOrSalesInvoiceTransactionDetailsActivity, android.R.layout.simple_list_item_1, materialList)
                ...
                firebaseOperationsForProjectInternalTransactionsTab.fetchSalesInvoiceTransaction(projectId, transactionId, object : FirebaseOperationsForProjectInternalTransactionsTab.OnSalesInvoiceTransactionFetched{
                    override fun onTransactionFetched(salesInvoice: TransactionSalesInvoice) {
                        ...
                        b.txnPartyNameView.text = "Party Name: " + salesInvoice.transactionParty
                        b.txnAdditionalChargesView.text = "Additional Charges: \u20b9" + salesInvoice.siAdditionalCharge
                        b.txnDiscountView.text = "Discount: \u20b9" + salesInvoice.siDiscount
                        b.txnCategoryView.text = "Category: " + salesInvoice.siCategory
                        b.txnAmountView.text = "Amount: \u20b9" + salesInvoice.transactionAmount
                        b.txnDescriptionView.text = "Description: " + salesInvoice.transactionDescription
                        val materialList = ArrayList<String>()
