...
class OtherExpenseTransactionDetailsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (projectId != "" && transactionId != null) {
            if (projectId != null) {
                if (transactionId != null) {
                    firebaseOperationsForProjectInternalTransactionsTab.fetchOtherExpenseTransaction(
                        projectId,
                        transactionId,
                        object :
                            FirebaseOperationsForProjectInternalTransactionsTab.OnOtherExpenseTransactionFetched {
                            override fun onTransactionFetched(otherExpense: TransactionOtherExpense) {
                                ...
                                b.txnAmountView.text =
                                    "Amount: \u20b9 " + otherExpense.transactionAmount
                                ...
                                b.txnDescriptionView.text =
                                    "Description: " + otherExpense.transactionDescription
                                b.txnUnitPriceView.text =
                                    "Unit Price: \u20b9" + otherExpense.otherExpenseTransactionUnitPrice
                                b.txnQuantityView.text =
                                    "Quantity: " + otherExpense.otherExpenseTransactionQuantity + " " + otherExpense.otherExpenseTransactionUnit
                                b.txnAdditionalChargesView.text =
                                    "Additional Charges: \u20b9" + otherExpense.otherExpenseTransactionAdditionalCharges
                                b.txnDiscountView.text =
                                    "Discount: \u20b9" + otherExpense.otherExpenseTransactionDiscount
                                b.txnCategoryView.text =
                                    "Category: " + otherExpense.otherExpenseTransactionCategory
                            }
            ...
            if(transactionId != null){
                ...
                firebaseOperationsForExternalPartyTab.fetchOtherExpenseTransaction(transactionId, object : FirebaseOperationsForExternalPartyTab.OnOtherExpenseTransactionFetched {
                    override fun onTransactionFetched(otherExpense: TransactionOtherExpense) {
                        b.transactionName.text = otherExpense.transactionType
                        b.txnAmountView.text =
                            "Amount: \u20b9 " + otherExpense.transactionAmount
